...
/**
 * AdvancedTechnology Component
 * 
 * This section highlights our core technologies and shows a live 3D model
 * of a thermal power plant as a demonstration of our capabilities.
 */
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
              {technologies.map((tech, i) => (
                <div 
                  key={i} 
                  className="px-5 py-2 bg-white/10 rounded-full text-sm border border-white/10 hover:bg-white/15 transition-colors"
                >
                  {tech}
                </div>
              ))}
